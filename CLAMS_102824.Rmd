...
# Remove data for mouse #1548 because the CLAMS data are very low - cage not functioning properly
CLAMS_Comb <- CLAMS_Comb %>% filter(!mouse == 1548)

# Test removing mouse #1546
CLAMS_Comb <- CLAMS_Comb %>% filter(!mouse == 1546 
                                    #& !mouse == 1549
                                    )
