...
CLAMS1_1451 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1451.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1468 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1468.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1469 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1469.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1470 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1470.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1482 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1482.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1523 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1523.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1541 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1541.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
#CLAMS1_1548 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1548.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1549 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1549.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1550 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1550.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1543 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1543.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1546 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1546.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1589 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1589.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1585 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1585.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
CLAMS1_1453 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest1/1453.csv", skip=1, col_types = coltypes) %>% select(1,2,4:11) %>% drop_na()
...
coltypes <- "ccdddddddd"
CLAMS2_1451 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1451.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1468 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1468.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1469 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1469.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1470 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1470.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1482 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1482.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1523 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1523.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1541 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1541.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
#CLAMS2_1548 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1548.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1549 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1549.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1550 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1550.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1543 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1543.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1546 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1546.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1589 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1589.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1585 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1585.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
CLAMS2_1453 <- read_delim("DATA/Side_Project/CLAMS_SP/CLAMStest2/1453.csv", skip=1, col_types = coltypes) %>% select(1:10) %>% drop_na()
...
```{r statistics for CLAMS, fig.height=2.5, fig.width=3.5}
...
data <- SummACF
knitr::kable(data,
caption = "VO2 phases in CLAMS1 and CLAMS2 data")
...
data <- SummACF
knitr::kable(data,
caption = "VCO2 phases in CLAMS1 and CLAMS2 data")
...
data <- SummACF
knitr::kable(data,
caption = "RER phases in CLAMS1 and CLAMS2 data")
...
data <- SummACF
knitr::kable(data,
caption = "FEED1 phases in CLAMS1 and CLAMS2 data")
...
data <- SummACF
knitr::kable(data,
caption = "DRINK phases in CLAMS1 and CLAMS2 data")
...
```{r generate CTRL XTOT time series}

StartDate <- as.Date("2024-02-05")
EndDate <- as.Date(StartDate) + 28

SeriesData <- CLAMS_Comb %>% filter(CorrectDate > StartDate & CorrectDate < EndDate)
#SeriesData$XTOTtest <- na.approx(SeriesData$XTOT)
...
mouseT0 <- SeriesT0 %>% filter(pill == Pill) %>% 
  select(datetime_corr, XTOT, Lightseries)
test <- mouseT0$XTOT
ts_mouse <- ts(test, start = 1, frequency = 4, deltat = 1)
#pT0 <- plot(ts_mouse)
testL <- mouseT0$Lightseries
...
```{r generate RW XTOT time series}
...
```{r boxplot for XTOT by group, fig.height=2, fig.width=3}
...
data <- SummACF
knitr::kable(data,
caption = "Activity periods and phases in CLAMS1 and CLAMS2 data")
...
data <- TwoWayTukey_Period[c(1:4,7,8), c(1:3,8:9)]
knitr::kable(data,
caption = "Two-way ANOVA for period in CLAMS XTOT data")
...
data <- TwoWayTukey_Phase[c(1:4,7,8), c(1:3,8:9)]
knitr::kable(data,
caption = "Two-way ANOVA for phase in CLAMS XTOT data")
...
bxp_CBT_phase + geom_boxplot() +
  scale_color_manual(values = c("CLAMS1" = "gray",
                                "CLAMS2" = "blue")) +
  ylim(8,16) +
    labs(title = "Phase in CLAMS XTOT",
         y = "Phase (ZT)") +
      theme_classic()
...
bxp_CBT_phaseB + geom_boxplot() +
  scale_color_manual(values = c("CTRL" = "black",
                                "RW" = "red")) +
  ylim(10,14) +
    labs(title = "Phase CLAMS XTOT",
         y = "Phase (ZT)") +
      theme_classic()

write_excel_csv(ACF_ALL, "PhaseCLAMS_XTOT.xls")
